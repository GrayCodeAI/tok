...
func (i *ImportFunctionality) Import(data []byte, format string) (interface{}, error) { return nil, nil }
...
func NewPluginMarketplace() *PluginMarketplace { return &PluginMarketplace{plugins: make(map[string]Plugin)} }
...
func NewCommunityPlugins() *CommunityPlugins { return &CommunityPlugins{registry: make(map[string]Plugin)} }
