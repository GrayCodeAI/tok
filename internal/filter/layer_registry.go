...
func defaultLayerMeta() []LayerMeta {
	...
	planned := []LayerMeta{
		{ID: "30_salience_graph", Name: "Salience Graph", Tier: LayerTierPlanned, Status: "planned", PaperRef: "GraphRAG-style ranking"},
		{ID: "31_trace_preserve", Name: "Trace Preserve", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Failure trace retention"},
		{ID: "32_ast_diff_focus", Name: "AST Diff Focus", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Syntax-guided diff compression"},
		{ID: "33_unit_test_focus", Name: "Unit Test Focus", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Test-aware pruning"},
		{ID: "34_symbol_table", Name: "Symbol Table Keep", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Code map compression"},
		{ID: "35_path_anchor", Name: "Path Anchor", Tier: LayerTierPlanned, Status: "planned", PaperRef: "File-path anchor heuristics"},
		{ID: "36_stacktrace_focus", Name: "Stacktrace Focus", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Runtime failure compression"},
		{ID: "37_exit_signal_keep", Name: "Exit Signal Keep", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Outcome-preserving compression"},
		{ID: "38_semantic_dedup", Name: "Semantic Dedup", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Semantic redundancy removal"},
		{ID: "39_recall_booster", Name: "Recall Booster", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Recall-constrained pruning"},
		{ID: "40_log_cluster", Name: "Log Cluster", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Log summarization clustering"},
		{ID: "41_error_window", Name: "Error Window", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Error-centric windowing"},
		{ID: "42_dependency_focus", Name: "Dependency Focus", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Dependency-aware context"},
		{ID: "43_symbolic_patch", Name: "Symbolic Patch", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Patch tokenization"},
		{ID: "44_runtime_anchor", Name: "Runtime Anchor", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Session continuity anchors"},
		{ID: "45_multiturn_merge", Name: "Multi-turn Merge", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Conversation compression"},
		{ID: "46_context_cache", Name: "Context Cache", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Cache-aware context reuse"},
		{ID: "47_confidence_gate", Name: "Confidence Gate", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Uncertainty-guided pruning"},
		{ID: "48_loss_guard", Name: "Loss Guard", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Faithfulness constraints"},
		{ID: "49_repair_pass", Name: "Repair Pass", Tier: LayerTierPlanned, Status: "planned", PaperRef: "Context repair"},
	}
