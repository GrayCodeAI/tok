...
func NewLayerSkipPredictor() *LayerSkipPredictor { return &LayerSkipPredictor{skipProb: make(map[int]float64)} }
...
func NewConfigurableHierarchical(d int) *ConfigurableHierarchical { return &ConfigurableHierarchical{depth: d} }
