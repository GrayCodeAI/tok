	...
	agents := []agentInfo{
		{
			...
			MarkerPath: home + "/.claude/hooks/tokman-rewrite.sh",
		},
		{
			Name:       "Cursor",
			DetectDir:  home + "/.cursor",
			ConfigDir:  home + "/.cursor",
			MarkerPath: home + "/.cursor/hooks/tokman-rewrite.sh",
		},
		{
			Name:       "Windsurf",
		...
		},
		{
			...
			MarkerPath: filepath.Join(home, ".config", "opencode", "plugins", "tokman.ts"),
		},
		{
			Name:       "OpenClaw",
			DetectDir:  home + "/.openclaw",
			ConfigDir:  home + "/.openclaw",
			MarkerPath: home + "/.openclaw/hooks/tokman-rewrite.sh",
		},
	}
